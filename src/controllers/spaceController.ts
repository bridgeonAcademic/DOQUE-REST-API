...
export const createSpace = async (req: Request, res: Response) => {
  ...
  res
    .status(201)
    .json(new StandardResponse("Space created successfully", newSpace, 201));
};
...
export const getAllSpaces = async (req: Request, res: Response) => {
  ...
  res
    .status(200)
    .json(new StandardResponse("Spaces fetched successfully", spaces, 200));
};
...
export const getSpaceById = async (req: Request, res: Response) => {
  ...
  res
    .status(200)
    .json(new StandardResponse("Space fetched successfully", space, 200));
};
...
export const updateSpaceById = async (req: Request, res: Response) => {
  ...
  res
    .status(200)
    .json(
      new StandardResponse("Space updated successfully", updatedSpace, 200)
    );
};
...
export const deleteSpaceById = async (req: Request, res: Response) => {
  ...
  res
    .status(200)
    .json(
      new StandardResponse("Space deleted successfully", deletedSpace, 200)
    );
};
